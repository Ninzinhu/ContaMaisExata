...
export default function TransactionForm() {
  ...
  const validateForm = () => {
    ...
    if (!title.trim()) newErrors.title = 'Nome da Transação é obrigatório';
    if (!amount.trim()) newErrors.amount = 'O valor é obrigatório';
    if (isNaN(parseFloat(amount))) newErrors.amount = 'O valor precisa ser um número válido';
  ...
  />
        ...
        >
          <Text style={styles.buttonText}>
            {isEditMode ? 'Update' : 'Add'} Transação
          </Text>
        </Pressable>
        ...
        {isEditMode && (
          ...
          >
            <Text style={styles.buttonText}>Deletar Transação</Text>
          </Pressable>
        )}
      </View>
    </ScrollView>
